...
![Selecting the correct dashboard for the user](../.gitbook/assets/intranda_workflow_artist_dictionary_1.png)

Once the selection has been made, the dashboard is available to the user after login:

![Dashboard of the Artist Dictionary Plugin](../.gitbook/assets/intranda_workflow_artist_dictionary_2.png)

From here, further processing of the entities can take place:

![Workflow plugin with the editing mask for the entities](../.gitbook/assets/intranda_workflow_artist_dictionary_3.png)
