---
description: >-
  This plugin displays the results of a validation of metadata within an
  accepted task.
---
...
![Selection of the plugin within a task](../.gitbook/assets/intranda_step_metadata_yerusha_validation1.png)
