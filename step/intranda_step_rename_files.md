...
| Dokumentation date | 06.Feb.2023 |
...
| `folder`  | This parameter allows the user to set which folder is to be affected by this plugin. If configured with * or not configured, then the default settings will be used. |
